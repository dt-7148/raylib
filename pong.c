...
// // Will store the position of the ball
// // This ball starts in the middle of the screen
// Vector2 ballPosition = {screenWidth / 2, screenHeight / 2};

// // These are the velocity values for the ball
// // They will switch from positive to negative and back again when they hit a wall
// int velocityX = 5;
// int velocityY = 5;

// // The ball will be 20 pixels in diameter
// int radius = 10;

// typedef enum {MENU, BALL, PAUSE} gameScreen;
...
//     if (curScreen == BALL) {
//         // check if ball is at edge, if it is, reverese velocity to bounce
//         if ((ballPosition.x == screenWidth - radius) || (ballPosition.x == 0 + radius)) {
//             velocityX = - velocityX;
//         }
        
//         if ((ballPosition.y == screenHeight - radius) || (ballPosition.y == 0 + radius)) {
//             velocityY = -velocityY;
//         }

//         // then, ball position + velocity
...
//         switch (curScreen) {
//             case MENU:
//                 DrawText("Click to watch a bouncing ball", screenWidth / 2, screenHeight / 2, 20, BLACK);
//                 break;
//             case BALL:
//                 DrawCircleV(ballPosition, radius, BLUE);
//                 break;
//             case PAUSE:
//                 DrawCircleV(ballPosition, radius, BLUE);
//                 DrawText("Paused", 0, screenHeight - 40, 20, BLACK);
//                 break;
//         }
